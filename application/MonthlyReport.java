...
public class MonthlyReport {
    private Stage monthlyReport; // stage to represent Data Range Report
    ...
    private static final  String TITLE = "Monthly Report"; // title of app
    ...
    public MonthlyReport(Stage mainMenu) {
        this.monthlyReport = mainMenu;
    }
    
    public Scene setUp() {
        // set the title 
        monthlyReport.setTitle(TITLE);
        
        // create a annual report scene        
        VBox root = annualR(); // Main layout of annual report 
        Scene monthlyScene = new Scene(root, WINDOW_WIDTH, WINDOW_HEIGHT);
       ...
       public VBox annualR(){
            ...
            back.setOnAction(e -> {
              MainPage mainPage = new MainPage(monthlyReport);
              ...
              monthlyReport.setScene(mainScene);
              monthlyReport.show();
            });
            ...
            firstNameCol.setCellValueFactory(
                    new PropertyValueFactory<Data, String>("farmID"));
     
            TableColumn lastNameCol = new TableColumn("Weights");
            lastNameCol.setMinWidth(100);
            lastNameCol.setCellValueFactory(
                    new PropertyValueFactory<Data, String>("weights"));
     
            TableColumn emailCol = new TableColumn("Percentage");
            emailCol.setMinWidth(200);
            emailCol.setCellValueFactory(
                    new PropertyValueFactory<Data, String>("percentage"));
	...
	private void saveButton(VBox v1) {
		...
		save.setOnAction(e -> {
			...
			File saved = fileChooser.showOpenDialog(monthlyReport);
			if (saved != null) {
